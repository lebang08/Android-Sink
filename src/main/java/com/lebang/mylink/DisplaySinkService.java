...
import com.lebang.mylink.Common.Protocol;
import com.lebang.mylink.Common.Service;
import com.lebang.mylink.Common.Transport;
        ...
        synchronized (mSurfaceAndCodecLock) {
            ...
            if (mSurface != null) {
                try {//TODO LeBang
                    ...
                    Toast.makeText(getContext(),"wrong = MediaFormat.createVideoFormat",Toast.LENGTH_LONG).show();
                    e.printStackTrace();
                }
            }
